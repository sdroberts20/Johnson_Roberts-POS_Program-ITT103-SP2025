...
def view_cart():
    if cart:
        ...
        for item_name, quantity in cart.items():
            ...
            print(f"{item_name:<15} {quantity:<8} ${item_price:<5}    ${total_price:}")
            total_cart_price += total_price  # calculating subtotal cart price
             
        print("--------------------------------------------")
        print(f"{'GRAND TOTAL':<24} ${total_cart_price}")
        print("--------------------------------------------")
        print("  ")
    else:
        print("--------------------------------------------")
    ...
    def process_payment(amount):
        while True:
            try:
                ...
                # checking if the user inputed a sufficent payment
                if payment >= amount:
